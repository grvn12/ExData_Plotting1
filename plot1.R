...
## plot 1 -- Histogram for Global Active Power -- output file : plot1.png
subsetData$Global_active_power <- as.numeric(subsetData$Global_active_power)
histinfo <- hist(subsetData$Global_active_power,xlab= "Global Active Power (Kilowattts)",ylab= "Frequency",col="red", main = "Global Active Power")
